...
description: "TL;DR
Need to wait for a page to show a specific string or pattern (e.g. in pages tailing some logs) and want to be notified, so you can go about other businesses while waiting? Use the JS Notification API along with bookmarklets to do the trick!
Mot..."
pubDate: '2021-09-22'
...
[https://gist.github.com/derlin/50b02e293f8dda69eb46f25ad97c63d7#file-waitfortext-js](https://gist.github.com/derlin/50b02e293f8dda69eb46f25ad97c63d7#file-waitfortext-js) 
