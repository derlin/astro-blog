...
description: "Too many tabs opened on mobile? PWA-ize the sites you visit the most, so they open in a dedicated window - as an app would! Free online service."
pubDate: '2021-12-07'
...
![without_pwa_open](./KOZPy6_iDF.gif)

and the same dev.to added through PWA-ize (Android 11):

![with_pwa_open](./_PLGCiR6m.gif)
...
[https://dev.to/derlin/get-favicons-from-any-website-using-a-hidden-google-api-3p1e](https://dev.to/derlin/get-favicons-from-any-website-using-a-hidden-google-api-3p1e) 
