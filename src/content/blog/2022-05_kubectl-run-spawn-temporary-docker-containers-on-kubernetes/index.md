...
description: "Learn how to use `kubectl run` to launch ephemeral containers on kubernetes, and why it may be useful to debug services such as kafka or postgres."
pubDate: '2022-05-26'
