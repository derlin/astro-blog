...
![Simple plot with plotly.express](./eoShPNi6X.png)
...
![Plotly plot with some layout customizations](./5ViMCBtSn.png)
...
![Suboptimal rendering of python notebook exported to HTML on mobile](./CBwN-zsnG.png)
